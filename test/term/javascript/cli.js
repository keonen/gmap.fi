...
var TerminalShell = {
	commands: {
			about: function(terminal) {

			terminal.print('This is an interactive web interface resembling a Unix terminal.');
		},
	
		help: function help(terminal) {
			terminal.print($('<h3>Command list:</h3>'));
			cmd_list = $('<ul>');
		...
		date: function(terminal) {
			...
			terminal.print("Date is: " + day + "/" + month + "/" + year);
		},
		time: function(terminal) {
			...
			terminal.print("Time is: " + hours + ":" + minutes + " " + ampm);
		},



			license: function(terminal) {

			terminal.print('This program is free software; you can redistribute it and/or');
			terminal.print('modify it under the terms of the GNU General Public License.');
